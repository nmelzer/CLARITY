...
mod_general_server=function(id, filter,breed.select,make.traff.light,approach.info,dt,add.approach.names){
  shiny::moduleServer(id, function(input, output, session){

  ns <- session$ns

  ## if the likelihood approach is within the selection
  ...
  ###### Output - correlations for selected approaches
