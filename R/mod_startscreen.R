...
mod_startscreen_ui <- function(id){
  ...
  tagList(
   ...
   # shiny::fluidRow(shiny::column(width=12,"TESTING - not all will work currently!!!")),
    shiny::fluidRow(shiny::column(width=12,style='margin-left: 0px;',
                    ...
                    shiny::column(11, tags$img(src = 'www/start-picture.jpg',alt="Picture showing different cattle breeds",width="62%", height="52%")), ##72% 62%
                    shiny::column(1,""),
