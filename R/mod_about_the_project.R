  ...
  shiny::tagList(
    ...
    htmltools::br(),
      shinydashboard::box(status="primary",width=12, solidHeader = TRUE,collapsible = FALSE,
              shiny::fluidRow(
                shiny::column(width=12,htmltools::tags$h4("Dairy cattle are strongly influenced by artificial selection. To manage a population under non-random mating conditions,
                                ...
                                htmltools::tags$h4("The project", htmltools::em("'The construction of a combined physical-genetic map for a dairy cattle breed in Germany (CLARITY)'"), "is supported by the grant from the",
                                                   htmltools::HTML("<a href = 'https://www.gesundheitsforschung-bmbf.de/de/clarity-die-entwicklung-einer-kombinierten-physisch-genetischen-karte-fur-eine-9212.php' target='_blank' >German Federal Ministry of Education and Research (BMBF, FKZ 031L0166 CompLS).</a>")),
                                htmltools::tags$a(href = 'https://www.gesundheitsforschung-bmbf.de/de/clarity-die-entwicklung-einer-kombinierten-physisch-genetischen-karte-fur-eine-9212.php',
                                                  htmltools::tags$img(src = 'www/BMBF_logo_en.png',alt="BMBF-logo", title = "Company Home",width="180px"), target="_blank",  ## target blank added also enables to open website in a new tab using a browser
